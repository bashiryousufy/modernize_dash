                ...
                <div className="flex flex-col lg:w-3/12 lg:gap-6">
                    ...
                    <div className=" bg-white h-[26] rounded-md p-5">
                        ...
                        <div className="mt-4">
                            ...
                            <input value={category?.name} type="text" className=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="" required />
                        </div>
